...
export const DAILY_TIPS = [
  ...
  },
  {
    ...
    "body": "Dziś mija miesiąc twoich odkryć. Jaki ślad zapamiętałeś najmocniej? Odkrywca po miesiącu ma już całą torbę skarbów w głowie.",
    "icon": "zwoj",
    "tone": "magic",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "Zacznijcie dzis od wspolnego oddechu i jednego zdania: 'cieszem sie, ze jestes moim/moja dzieckiem'. To wystarczy. Przyjaciel to zapamieta na lata.",
    "icon": "rodzic",
    "tone": "amber",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "Mędrzec opowiada: w Górach Liczb poranki zaczynają się od cichego liczenia oddechów. Spróbuj policzyć pięć wdechów, zanim wstaniesz z łóżka.",
    "icon": "krysztal",
    "tone": "magic",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "Dobry dzień, {mały|mała} {Śmiałku|Śmiałko}. Zanim wstaniesz, połóż rękę na piersi. Posłuchaj jednej rzeczy, którą serce ci podpowie. To twój pierwszy krok.",
    "icon": "medrzec",
    "tone": "amber",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "{Mały|Mała} {Śmiałku|Śmiałko}, zacznij dzień od myśli: „dziś jestem dla kogoś”. Nie musisz wiedzieć dla kogo. Życie ci podpowie. Tarcza Słońca rozgrzewa twoją pierś.",
    "icon": "artifact",
    "tone": "amber",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "Posłuchaj, {mały|mała} {Śmiałku|Śmiałko}: lider, który nie śpi, traci tarczę. Idź spać tak, żeby spać 9 do 13 godzin. To nie jest słabość. To naładowanie grzywy.",
    "icon": "medrzec",
    "tone": "rose",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "{Śmiałku|Śmiałko}, ustaw się dziś tak: pierś do przodu, ramiona w dół, oczy miękkie. Ciało powie sercu: „jestem gotowa, jestem gotowy”. I dzień zacznie się dobrze.",
    "icon": "pulse",
    "tone": "amber",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "Posłuchaj, {mały|mała} {Śmiałku|Śmiałko}: nie musisz dziś robić niczego wielkiego. Powiedzieć „dzień dobry” pani, której się boisz — to też odwaga. Liczy się każdy krok.",
    "icon": "medrzec",
    "tone": "amber",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "{Śmiałku|Śmiałko}, dziś poranny sekret: nie planuj dziesięciu rzeczy. Wybierz jeden krok odwagi. Tylko jeden. Mały. Konkretny. Zrobisz go i basta.",
    "icon": "pulse",
    "tone": "amber",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "{Mały|Mała} {Śmiałku|Śmiałko}, jesteś już dwa tygodnie ze mną. Twoja Tarcza Słońca jest cieplejsza. Połóż dłoń na piersi. Czujesz? To nie ja zrobiłam — to ty.",
    "icon": "artifact",
    "tone": "magic",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "Połowa drogi za nami, {Śmiałku|Śmiałko}. Dziś rano nie biegnij. Usiądź na łóżku przez minutę. Posłuchaj oddechu. Śmiałek, który umie przystanąć, idzie dalej.",
    "icon": "medrzec",
    "tone": "rose",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "Posłuchaj, {mały|mała} {Śmiałku|Śmiałko}: tam, gdzie się trochę boisz, ale wiesz, że jest dobrze, tam idź. Nie tam, gdzie jest niebezpiecznie. Tam, gdzie jest TRUDNO, ale DOBRZE.",
    "icon": "medrzec",
    "tone": "amber",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "{Mały|Mała} {Śmiałku|Śmiałko}, dziś spróbuj: cokolwiek się stanie, najpierw oddech, potem słowa. Lwia grzywa nie musi ryczeć. Może mówić cicho i też być słyszana.",
    "icon": "medrzec",
    "tone": "amber",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "Wyobraź sobie, że Mędrzec patrzy z chmury i widzi twój dzień. Co mówi? Nie krzyczy. Mówi: „widzę cię, {mały Śmiałku|mała Śmiałko}. Jesteś w porządku”.",
    "icon": "medrzec",
    "tone": "magic",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "Posłuchaj, {mały|mała} {Śmiałku|Śmiałko}: twoja zbroja jest z miękkiej gliny, nie z twardego żelaza. To dlatego, że odwaga ma być ciepła, a nie zimna. Można w niej oddychać.",
    "icon": "artifact",
    "tone": "rose",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "slot": "poranek",
    "category": "medrzec",
    "title": "Trzy tygodnie — gdzie {urosłeś|urosłaś}?",
    "body": "{Mały|Mała} {Śmiałku|Śmiałko}, trzy tygodnie ze mną. Zatrzymaj się rano i zauważ jedną rzecz, w której jesteś inaczej niż na początku. Może bardziej spokojnie. Może bardziej śmiało.",
    "icon": "pulse",
    "tone": "magic",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "Posłuchaj, {Śmiałku|Śmiałko}: lwy odpoczywają wiele godzin dziennie. Tylko wtedy są silne. Dziś zaplanuj jedną rzecz, którą zrobisz powoli, dla siebie. Bez celu. Po prostu.",
    "icon": "medrzec",
    "tone": "rose",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "Posłuchaj, {Śmiałku|Śmiałko}: gdy nie wiesz, jak postąpić, połóż dłoń na piersi i zapytaj: „co jest dobre?”. Nie „co jest łatwe”, nie „co inni powiedzą”. Co jest DOBRE. Tam jest twój kompas.",
    "icon": "medrzec",
    "tone": "amber",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "{Mały|Mała} {Śmiałku|Śmiałko}, dzisiejszy poranny szept Mędrzec: nie musisz dziś niczego wygrać. Nie musisz być najlepsza/najlepszy. Wystarczy, że będziesz sobą. Tyle.",
    "icon": "medrzec",
    "tone": "rose",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "Spójrz dziś rano w okno. Gdziekolwiek jesteś — słońce nad Niebem Marzeń wschodzi razem ze słońcem u ciebie. To samo słońce świeci wszystkim Śmiałkom na świecie.",
    "icon": "artifact",
    "tone": "magic",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "{Mały|Mała} {Śmiałku|Śmiałko}, ostatni wschód razem. Połóż obie dłonie na piersi. Powiedz cicho: „mam tarczę, mam grzywę, mam serce”. Ja, Mędrzec, kłaniam ci się.",
    "icon": "medrzec",
    "tone": "magic",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "{Drogi|Droga} {Śmiałku|Śmiałko}, kończymy 30 dni. Pamiętaj: Niebo Marzeń jest twoje na zawsze. Tarcza Słońca nigdy nie znika. Idziesz pierwsza, idziesz pierwszy — nie z pychy, z troski. Tak trzymaj.",
    "icon": "artifact",
    "tone": "magic",
    "time": "1 min",
    "tags": [
  ...
  },
  {
    ...
    "body": "W Zamku Czasu poranek jest najcichszą porą. Mędrzec mówi: zanim świat zacznie hałasować, posłuchaj swojego serca. Co bije w nim dzisiaj?",
    "icon": "krysztal",
    "tone": "magic",
    "time": "1 min",
    "tags": [
