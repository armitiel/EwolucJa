...
`].filter($s).join(`
`)),o=kc(o),o=au(o,e),o=cu(o,e),a=kc(a),a=au(a,e),a=cu(a,e),o=lu(o),a=lu(a),e.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
`)+`
`+p);let v=M+m+o,S=M+p+a,P=ru(i,i.VERTEX_SHADER,v),T=ru(i,i.FRAGMENT_SHADER,S);i.attachShader(_,P),i.attachShader(_,T),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function E(w){if(s.debug.checkShaderErrors){let k=i.getProgramInfoLog(_).trim(),z=i.getShaderInfoLog(P).trim(),B=i.getShaderInfoLog(T).trim(),Y=!0,H=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(Y=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,P,T);else{let J=ou(i,P,"vertex"),X=ou(i,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
Program Info Log: `+k+`
`+J+`
`+X)}else k!==""?console.warn("THREE.WebGLProgram: Program Info Log:",k):(z===""||B==="")&&(H=!1);H&&(w.diagnostics={runnable:Y,programLog:k,vertexShader:{log:z,prefix:m},fragmentShader:{log:B,prefix:p}})}i.deleteShader(P),i.deleteShader(T),C=new ms(i,_),F=x_(i,_)}let C;this.getUniforms=function(){return C===void 0&&E(this),C};let F;this.getAttributes=function(){return F===void 0&&E(this),F};let y=e.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return y===!1&&(y=i.getProgramParameter(_,l_)),y},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(_),this.program=void 0},this.type=e.shaderType,this.name=e.shaderName,this.id=h_++,this.cacheKey=t,this.usedTimes=1,this.program=_,this.vertexShader=P,this.fragmentShader=T,this}var P_=0,Uc=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){let e=t.vertexShader,n=t.fragmentShader,i=this._getShaderStage(e),r=this._getShaderStage(n),o=this._getShaderCacheForMaterial(t);return o.has(i)===!1&&(o.add(i),i.usedTimes++),o.has(r)===!1&&(o.add(r),r.usedTimes++),this}remove(t){let e=this.materialCache.get(t);for(let n of e)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){let e=this.materialCache,n=e.get(t);return n===void 0&&(n=new Set,e.set(t,n)),n}_getShaderStage(t){let e=this.shaderCache,n=e.get(t);return n===void 0&&(n=new Oc(t),e.set(t,n)),n}},Oc=class{constructor(t){this.id=P_++,this.code=t,this.usedTimes=0}};function I_(s,t,e,n,i,r,o){let a=new or,c=new Uc,l=new Set,h=[],u=i.logarithmicDepthBuffer,d=i.reverseDepthBuffer,f=i.vertexTextures,g=i.precision,_={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function m(y){return l.add(y),y===0?"uv":`uv${y}`}function p(y,w,k,z,B){let Y=z.fog,H=B.geometry,J=y.isMeshStandardMaterial?z.environment:null,X=(y.isMeshStandardMaterial?e:t).get(y.envMap||J),ot=X&&X.mapping===Uo?X.image.height:null,at=_[y.type];y.precision!==null&&(g=i.getMaxPrecision(y.precision),g!==y.precision&&console.warn("THREE.WebGLProgram.getParameters:",y.precision,"not supported, using",g,"instead."));let mt=H.morphAttributes.position||H.morphAttributes.normal||H.morphAttributes.color,Ut=mt!==void 0?mt.length:0,Yt=0;H.morphAttributes.position!==void 0&&(Yt=1),H.morphAttributes.normal!==void 0&&(Yt=2),H.morphAttributes.color!==void 0&&(Yt=3);let Z,Q,ut,ft;if(at){let Ge=Sn[at];Z=Ge.vertexShader,Q=Ge.fragmentShader}else Z=y.vertexShader,Q=y.fragmentShader,c.update(y),ut=c.getVertexShaderID(y),ft=c.getFragmentShaderID(y);let Lt=s.getRenderTarget(),vt=B.isInstancedMesh===!0,Ot=B.isBatchedMesh===!0,Kt=!!y.map,Ht=!!y.matcap,I=!!X,ke=!!y.aoMap,Vt=!!y.lightMap,Ft=!!y.bumpMap,At=!!y.normalMap,ie=!!y.displacementMap,Ct=!!y.emissiveMap,R=!!y.metalnessMap,x=!!y.roughnessMap,D=y.anisotropy>0,L=y.clearcoat>0,K=y.dispersion>0,W=y.iridescence>0,it=y.sheen>0,tt=y.transmission>0,nt=D&&!!y.anisotropyMap,_t=L&&!!y.clearcoatMap,$=L&&!!y.clearcoatNormalMap,gt=L&&!!y.clearcoatRoughnessMap,Pt=W&&!!y.iridescenceMap,Et=W&&!!y.iridescenceThicknessMap,dt=it&&!!y.sheenColorMap,Gt=it&&!!y.sheenRoughnessMap,zt=!!y.specularMap,Jt=!!y.specularColorMap,N=!!y.specularIntensityMap,ct=tt&&!!y.transmissionMap,q=tt&&!!y.thicknessMap,j=!!y.gradientMap,lt=!!y.alphaMap,pt=y.alphaTest>0,Zt=!!y.alphaHash,_e=!!y.extensions,Ve=li;y.toneMapped&&(Lt===null||Lt.isXRRenderTarget===!0)&&(Ve=s.toneMapping);let Qt={shaderID:at,shaderType:y.type,shaderName:y.name,vertexShader:Z,fragmentShader:Q,defines:y.defines,customVertexShaderID:ut,customFragmentShaderID:ft,isRawShaderMaterial:y.isRawShaderMaterial===!0,glslVersion:y.glslVersion,precision:g,batching:Ot,batchingColor:Ot&&B._colorsTexture!==null,instancing:vt,instancingColor:vt&&B.instanceColor!==null,instancingMorph:vt&&B.morphTexture!==null,supportsVertexTextures:f,outputColorSpace:Lt===null?s.outputColorSpace:Lt.isXRRenderTarget===!0?Lt.texture.colorSpace:Ee,alphaToCoverage:!!y.alphaToCoverage,map:Kt,matcap:Ht,envMap:I,envMapMode:I&&X.mapping,envMapCubeUVHeight:ot,aoMap:ke,lightMap:Vt,bumpMap:Ft,normalMap:At,displacementMap:f&&ie,emissiveMap:Ct,normalMapObjectSpace:At&&y.normalMapType===zf,normalMapTangentSpace:At&&y.normalMapType===vl,metalnessMap:R,roughnessMap:x,anisotropy:D,anisotropyMap:nt,clearcoat:L,clearcoatMap:_t,clearcoatNormalMap:$,clearcoatRoughnessMap:gt,dispersion:K,iridescence:W,iridescenceMap:Pt,iridescenceThicknessMap:Et,sheen:it,sheenColorMap:dt,sheenRoughnessMap:Gt,specularMap:zt,specularColorMap:Jt,specularIntensityMap:N,transmission:tt,transmissionMap:ct,thicknessMap:q,gradientMap:j,opaque:y.transparent===!1&&y.blending===ds&&y.alphaToCoverage===!1,alphaMap:lt,alphaTest:pt,alphaHash:Zt,combine:y.combine,mapUv:Kt&&m(y.map.channel),aoMapUv:ke&&m(y.aoMap.channel),lightMapUv:Vt&&m(y.lightMap.channel),bumpMapUv:Ft&&m(y.bumpMap.channel),normalMapUv:At&&m(y.normalMap.channel),displacementMapUv:ie&&m(y.displacementMap.channel),emissiveMapUv:Ct&&m(y.emissiveMap.channel),metalnessMapUv:R&&m(y.metalnessMap.channel),roughnessMapUv:x&&m(y.roughnessMap.channel),anisotropyMapUv:nt&&m(y.anisotropyMap.channel),clearcoatMapUv:_t&&m(y.clearcoatMap.channel),clearcoatNormalMapUv:$&&m(y.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:gt&&m(y.clearcoatRoughnessMap.channel),iridescenceMapUv:Pt&&m(y.iridescenceMap.channel),iridescenceThicknessMapUv:Et&&m(y.iridescenceThicknessMap.channel),sheenColorMapUv:dt&&m(y.sheenColorMap.channel),sheenRoughnessMapUv:Gt&&m(y.sheenRoughnessMap.channel),specularMapUv:zt&&m(y.specularMap.channel),specularColorMapUv:Jt&&m(y.specularColorMap.channel),specularIntensityMapUv:N&&m(y.specularIntensityMap.channel),transmissionMapUv:ct&&m(y.transmissionMap.channel),thicknessMapUv:q&&m(y.thicknessMap.channel),alphaMapUv:lt&&m(y.alphaMap.channel),vertexTangents:!!H.attributes.tangent&&(At||D),vertexColors:y.vertexColors,vertexAlphas:y.vertexColors===!0&&!!H.attributes.color&&H.attributes.color.itemSize===4,pointsUvs:B.isPoints===!0&&!!H.attributes.uv&&(Kt||lt),fog:!!Y,useFog:y.fog===!0,fogExp2:!!Y&&Y.isFogExp2,flatShading:y.flatShading===!0,sizeAttenuation:y.sizeAttenuation===!0,logarithmicDepthBuffer:u,reverseDepthBuffer:d,skinning:B.isSkinnedMesh===!0,morphTargets:H.morphAttributes.position!==void 0,morphNormals:H.morphAttributes.normal!==void 0,morphColors:H.morphAttributes.color!==void 0,morphTargetsCount:Ut,morphTextureStride:Yt,numDirLights:w.directional.length,numPointLights:w.point.length,numSpotLights:w.spot.length,numSpotLightMaps:w.spotLightMap.length,numRectAreaLights:w.rectArea.length,numHemiLights:w.hemi.length,numDirLightShadows:w.directionalShadowMap.length,numPointLightShadows:w.pointShadowMap.length,numSpotLightShadows:w.spotShadowMap.length,numSpotLightShadowsWithMaps:w.numSpotLightShadowsWithMaps,numLightProbes:w.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:y.dithering,shadowMapEnabled:s.shadowMap.enabled&&k.length>0,shadowMapType:s.shadowMap.type,toneMapping:Ve,decodeVideoTexture:Kt&&y.map.isVideoTexture===!0&&jt.getTransfer(y.map.colorSpace)===le,premultipliedAlpha:y.premultipliedAlpha,doubleSided:y.side===ve,flipSided:y.side===Ne,useDepthPacking:y.depthPacking>=0,depthPacking:y.depthPacking||0,index0AttributeName:y.index0AttributeName,extensionClipCullDistance:_e&&y.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(_e&&y.extensions.multiDraw===!0||Ot)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:y.customProgramCacheKey()};return Qt.vertexUv1s=l.has(1),Qt.vertexUv2s=l.has(2),Qt.vertexUv3s=l.has(3),l.clear(),Qt}function M(y){let w=[];if(y.shaderID?w.push(y.shaderID):(w.push(y.customVertexShaderID),w.push(y.customFragmentShaderID)),y.defines!==void 0)for(let k in y.defines)w.push(k),w.push(y.defines[k]);return y.isRawShaderMaterial===!1&&(v(w,y),S(w,y),w.push(s.outputColorSpace)),w.push(y.customProgramCacheKey),w.join()}function v(y,w){y.push(w.precision),y.push(w.outputColorSpace),y.push(w.envMapMode),y.push(w.envMapCubeUVHeight),y.push(w.mapUv),y.push(w.alphaMapUv),y.push(w.lightMapUv),y.push(w.aoMapUv),y.push(w.bumpMapUv),y.push(w.normalMapUv),y.push(w.displacementMapUv),y.push(w.emissiveMapUv),y.push(w.metalnessMapUv),y.push(w.roughnessMapUv),y.push(w.anisotropyMapUv),y.push(w.clearcoatMapUv),y.push(w.clearcoatNormalMapUv),y.push(w.clearcoatRoughnessMapUv),y.push(w.iridescenceMapUv),y.push(w.iridescenceThicknessMapUv),y.push(w.sheenColorMapUv),y.push(w.sheenRoughnessMapUv),y.push(w.specularMapUv),y.push(w.specularColorMapUv),y.push(w.specularIntensityMapUv),y.push(w.transmissionMapUv),y.push(w.thicknessMapUv),y.push(w.combine),y.push(w.fogExp2),y.push(w.sizeAttenuation),y.push(w.morphTargetsCount),y.push(w.morphAttributeCount),y.push(w.numDirLights),y.push(w.numPointLights),y.push(w.numSpotLights),y.push(w.numSpotLightMaps),y.push(w.numHemiLights),y.push(w.numRectAreaLights),y.push(w.numDirLightShadows),y.push(w.numPointLightShadows),y.push(w.numSpotLightShadows),y.push(w.numSpotLightShadowsWithMaps),y.push(w.numLightProbes),y.push(w.shadowMapType),y.push(w.toneMapping),y.push(w.numClippingPlanes),y.push(w.numClipIntersection),y.push(w.depthPacking)}function S(y,w){a.disableAll(),w.supportsVertexTextures&&a.enable(0),w.instancing&&a.enable(1),w.instancingColor&&a.enable(2),w.instancingMorph&&a.enable(3),w.matcap&&a.enable(4),w.envMap&&a.enable(5),w.normalMapObjectSpace&&a.enable(6),w.normalMapTangentSpace&&a.enable(7),w.clearcoat&&a.enable(8),w.iridescence&&a.enable(9),w.alphaTest&&a.enable(10),w.vertexColors&&a.enable(11),w.vertexAlphas&&a.enable(12),w.vertexUv1s&&a.enable(13),w.vertexUv2s&&a.enable(14),w.vertexUv3s&&a.enable(15),w.vertexTangents&&a.enable(16),w.anisotropy&&a.enable(17),w.alphaHash&&a.enable(18),w.batching&&a.enable(19),w.dispersion&&a.enable(20),w.batchingColor&&a.enable(21),y.push(a.mask),a.disableAll(),w.fog&&a.enable(0),w.useFog&&a.enable(1),w.flatShading&&a.enable(2),w.logarithmicDepthBuffer&&a.enable(3),w.reverseDepthBuffer&&a.enable(4),w.skinning&&a.enable(5),w.morphTargets&&a.enable(6),w.morphNormals&&a.enable(7),w.morphColors&&a.enable(8),w.premultipliedAlpha&&a.enable(9),w.shadowMapEnabled&&a.enable(10),w.doubleSided&&a.enable(11),w.flipSided&&a.enable(12),w.useDepthPacking&&a.enable(13),w.dithering&&a.enable(14),w.transmission&&a.enable(15),w.sheen&&a.enable(16),w.opaque&&a.enable(17),w.pointsUvs&&a.enable(18),w.decodeVideoTexture&&a.enable(19),w.alphaToCoverage&&a.enable(20),y.push(a.mask)}function P(y){let w=_[y.type],k;if(w){let z=Sn[w];k=Mp.clone(z.uniforms)}else k=y.uniforms;return k}function T(y,w){let k;for(let z=0,B=h.length;z<B;z++){let Y=h[z];if(Y.cacheKey===w){k=Y,++k.usedTimes;break}}return k===void 0&&(k=new C_(s,w,y,r),h.push(k)),k}function E(y){if(--y.usedTimes===0){let w=h.indexOf(y);h[w]=h[h.length-1],h.pop(),y.destroy()}}function C(y){c.remove(y)}function F(){c.dispose()}return{getParameters:p,getProgramCacheKey:M,getUniforms:P,acquireProgram:T,releaseProgram:E,releaseShaderCache:C,programs:h,dispose:F}}function L_(){let s=new WeakMap;function t(o){return s.has(o)}function e(o){let a=s.get(o);return a===void 0&&(a={},s.set(o,a)),a}function n(o){s.delete(o)}function i(o,a,c){s.get(o)[a]=c}function r(){s=new WeakMap}return{has:t,get:e,remove:n,update:i,dispose:r}}function z_(s,t){return s.groupOrder!==t.groupOrder?s.groupOrder-t.groupOrder:s.renderOrder!==t.renderOrder?s.renderOrder-t.renderOrder:s.material.id!==t.material.id?s.material.id-t.material.id:s.z!==t.z?s.z-t.z:s.id-t.id}function uu(s,t){return s.groupOrder!==t.groupOrder?s.groupOrder-t.groupOrder:s.renderOrder!==t.renderOrder?s.renderOrder-t.renderOrder:s.z!==t.z?t.z-s.z:s.id-t.id}function du(){let s=[],t=0,e=[],n=[],i=[];function r(){t=0,e.length=0,n.length=0,i.length=0}function o(u,d,f,g,_,m){let p=s[t];return p===void 0?(p={id:u.id,object:u,geometry:d,material:f,groupOrder:g,renderOrder:u.renderOrder,z:_,group:m},s[t]=p):(p.id=u.id,p.object=u,p.geometry=d,p.material=f,p.groupOrder=g,p.renderOrder=u.renderOrder,p.z=_,p.group=m),t++,p}function a(u,d,f,g,_,m){let p=o(u,d,f,g,_,m);f.transmission>0?n.push(p):f.transparent===!0?i.push(p):e.push(p)}function c(u,d,f,g,_,m){let p=o(u,d,f,g,_,m);f.transmission>0?n.unshift(p):f.transparent===!0?i.unshift(p):e.unshift(p)}function l(u,d){e.length>1&&e.sort(u||z_),n.length>1&&n.sort(d||uu),i.length>1&&i.sort(d||uu)}function h(){for(let u=t,d=s.length;u<d;u++){let f=s[u];if(f.id===null)break;f.id=null,f.object=null,f.geometry=null,f.material=null,f.group=null}}return{opaque:e,transmissive:n,transparent:i,init:r,push:a,unshift:c,finish:h,sort:l}}function D_(){let s=new WeakMap;function t(n,i){let r=s.get(n),o;return r===void 0?(o=new du,s.set(n,[o])):i>=r.length?(o=new du,r.push(o)):o=r[i],o}function e(){s=new WeakMap}return{get:t,dispose:e}}function N_(){let s={};return{get:function(t){if(s[t.id]!==void 0)return s[t.id];let e;switch(t.type){case"DirectionalLight":e={direction:new A,color:new st};break;case"SpotLight":e={position:new A,direction:new A,color:new st,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":e={position:new A,color:new st,distance:0,decay:0};break;case"HemisphereLight":e={direction:new A,skyColor:new st,groundColor:new st};break;case"RectAreaLight":e={color:new st,position:new A,halfWidth:new A,halfHeight:new A};break}return s[t.id]=e,e}}}function k_(){let s={};return{get:function(t){if(s[t.id]!==void 0)return s[t.id];let e;switch(t.type){case"DirectionalLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new bt};break;case"SpotLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new bt};break;case"PointLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new bt,shadowCameraNear:1,shadowCameraFar:1e3};break}return s[t.id]=e,e}}}var U_=0;function O_(s,t){return(t.castShadow?2:0)-(s.castShadow?2:0)+(t.map?1:0)-(s.map?1:0)}function F_(s){let t=new N_,e=k_(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)n.probe.push(new A);let i=new A,r=new Tt,o=new Tt;function a(l){let h=0,u=0,d=0;for(let F=0;F<9;F++)n.probe[F].set(0,0,0);let f=0,g=0,_=0,m=0,p=0,M=0,v=0,S=0,P=0,T=0,E=0;l.sort(O_);for(let F=0,y=l.length;F<y;F++){let w=l[F],k=w.color,z=w.intensity,B=w.distance,Y=w.shadow&&w.shadow.map?w.shadow.map.texture:null;if(w.isAmbientLight)h+=k.r*z,u+=k.g*z,d+=k.b*z;else if(w.isLightProbe){for(let H=0;H<9;H++)n.probe[H].addScaledVector(w.sh.coefficients[H],z);E++}else if(w.isDirectionalLight){let H=t.get(w);if(H.color.copy(w.color).multiplyScalar(w.intensity),w.castShadow){let J=w.shadow,X=e.get(w);X.shadowIntensity=J.intensity,X.shadowBias=J.bias,X.shadowNormalBias=J.normalBias,X.shadowRadius=J.radius,X.shadowMapSize=J.mapSize,n.directionalShadow[f]=X,n.directionalShadowMap[f]=Y,n.directionalShadowMatrix[f]=w.shadow.matrix,M++}n.directional[f]=H,f++}else if(w.isSpotLight){let H=t.get(w);H.position.setFromMatrixPosition(w.matrixWorld),H.color.copy(k).multiplyScalar(z),H.distance=B,H.coneCos=Math.cos(w.angle),H.penumbraCos=Math.cos(w.angle*(1-w.penumbra)),H.decay=w.decay,n.spot[_]=H;let J=w.shadow;if(w.map&&(n.spotLightMap[P]=w.map,P++,J.updateMatrices(w),w.castShadow&&T++),n.spotLightMatrix[_]=J.matrix,w.castShadow){let X=e.get(w);X.shadowIntensity=J.intensity,X.shadowBias=J.bias,X.shadowNormalBias=J.normalBias,X.shadowRadius=J.radius,X.shadowMapSize=J.mapSize,n.spotShadow[_]=X,n.spotShadowMap[_]=Y,S++}_++}else if(w.isRectAreaLight){let H=t.get(w);H.color.copy(k).multiplyScalar(z),H.halfWidth.set(w.width*.5,0,0),H.halfHeight.set(0,w.height*.5,0),n.rectArea[m]=H,m++}else if(w.isPointLight){let H=t.get(w);if(H.color.copy(w.color).multiplyScalar(w.intensity),H.distance=w.distance,H.decay=w.decay,w.castShadow){let J=w.shadow,X=e.get(w);X.shadowIntensity=J.intensity,X.shadowBias=J.bias,X.shadowNormalBias=J.normalBias,X.shadowRadius=J.radius,X.shadowMapSize=J.mapSize,X.shadowCameraNear=J.camera.near,X.shadowCameraFar=J.camera.far,n.pointShadow[g]=X,n.pointShadowMap[g]=Y,n.pointShadowMatrix[g]=w.shadow.matrix,v++}n.point[g]=H,g++}else if(w.isHemisphereLight){let H=t.get(w);H.skyColor.copy(w.color).multiplyScalar(z),H.groundColor.copy(w.groundColor).multiplyScalar(z),n.hemi[p]=H,p++}}m>0&&(s.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=rt.LTC_FLOAT_1,n.rectAreaLTC2=rt.LTC_FLOAT_2):(n.rectAreaLTC1=rt.LTC_HALF_1,n.rectAreaLTC2=rt.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=u,n.ambient[2]=d;let C=n.hash;(C.directionalLength!==f||C.pointLength!==g||C.spotLength!==_||C.rectAreaLength!==m||C.hemiLength!==p||C.numDirectionalShadows!==M||C.numPointShadows!==v||C.numSpotShadows!==S||C.numSpotMaps!==P||C.numLightProbes!==E)&&(n.directional.length=f,n.spot.length=_,n.rectArea.length=m,n.point.length=g,n.hemi.length=p,n.directionalShadow.length=M,n.directionalShadowMap.length=M,n.pointShadow.length=v,n.pointShadowMap.length=v,n.spotShadow.length=S,n.spotShadowMap.length=S,n.directionalShadowMatrix.length=M,n.pointShadowMatrix.length=v,n.spotLightMatrix.length=S+P-T,n.spotLightMap.length=P,n.numSpotLightShadowsWithMaps=T,n.numLightProbes=E,C.directionalLength=f,C.pointLength=g,C.spotLength=_,C.rectAreaLength=m,C.hemiLength=p,C.numDirectionalShadows=M,C.numPointShadows=v,C.numSpotShadows=S,C.numSpotMaps=P,C.numLightProbes=E,n.version=U_++)}function c(l,h){let u=0,d=0,f=0,g=0,_=0,m=h.matrixWorldInverse;for(let p=0,M=l.length;p<M;p++){let v=l[p];if(v.isDirectionalLight){let S=n.directional[u];S.direction.setFromMatrixPosition(v.matrixWorld),i.setFromMatrixPosition(v.target.matrixWorld),S.direction.sub(i),S.direction.transformDirection(m),u++}else if(v.isSpotLight){let S=n.spot[f];S.position.setFromMatrixPosition(v.matrixWorld),S.position.applyMatrix4(m),S.direction.setFromMatrixPosition(v.matrixWorld),i.setFromMatrixPosition(v.target.matrixWorld),S.direction.sub(i),S.direction.transformDirection(m),f++}else if(v.isRectAreaLight){let S=n.rectArea[g];S.position.setFromMatrixPosition(v.matrixWorld),S.position.applyMatrix4(m),o.identity(),r.copy(v.matrixWorld),r.premultiply(m),o.extractRotation(r),S.halfWidth.set(v.width*.5,0,0),S.halfHeight.set(0,v.height*.5,0),S.halfWidth.applyMatrix4(o),S.halfHeight.applyMatrix4(o),g++}else if(v.isPointLight){let S=n.point[d];S.position.setFromMatrixPosition(v.matrixWorld),S.position.applyMatrix4(m),d++}else if(v.isHemisphereLight){let S=n.hemi[_];S.direction.setFromMatrixPosition(v.matrixWorld),S.direction.transformDirection(m),_++}}}return{setup:a,setupView:c,state:n}}function fu(s){let t=new F_(s),e=[],n=[];function i(h){l.camera=h,e.length=0,n.length=0}function r(h){e.push(h)}function o(h){n.push(h)}function a(){t.setup(e)}function c(h){t.setupView(e,h)}let l={lightsArray:e,shadowsArray:n,camera:null,lights:t,transmissionRenderTarget:{}};return{init:i,state:l,setupLights:a,setupLightsView:c,pushLight:r,pushShadow:o}}function B_(s){let t=new WeakMap;function e(i,r=0){let o=t.get(i),a;return o===void 0?(a=new fu(s),t.set(i,[a])):r>=o.length?(a=new fu(s),o.push(a)):a=o[r],a}function n(){t=new WeakMap}return{get:e,dispose:n}}var Fc=class extends Fe{constructor(t){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=If,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(t)}copy(t){return super.copy(t),this.depthPacking=t.depthPacking,this.map=t.map,this.alphaMap=t.alphaMap,this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this.wireframe=t.wireframe,this.wireframeLinewidth=t.wireframeLinewidth,this}},Bc=class extends Fe{constructor(t){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(t)}copy(t){return super.copy(t),this.map=t.map,this.alphaMap=t.alphaMap,this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this}},H_=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function G_(s,t,e){let n=new ar,i=new bt,r=new bt,o=new qt,a=new Fc({depthPacking:Lf}),c=new Bc,l={},h=e.maxTextureSize,u={[An]:Ne,[Ne]:An,[ve]:ve},d=new cn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new bt},radius:{value:4}},vertexShader:H_,fragmentShader:V_}),f=d.clone();f.defines.HORIZONTAL_PASS=1;let g=new he;g.setAttribute("position",new Me(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let _=new Wt(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Uu;let p=this.type;this.render=function(T,E,C){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;let F=s.getRenderTarget(),y=s.getActiveCubeFace(),w=s.getActiveMipmapLevel(),k=s.state;k.setBlending(ci),k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);let z=p!==Un&&this.type===Un,B=p===Un&&this.type!==Un;for(let Y=0,H=T.length;Y<H;Y++){let J=T[Y],X=J.shadow;if(X===void 0){console.warn("THREE.WebGLShadowMap:",J,"has no shadow.");continue}if(X.autoUpdate===!1&&X.needsUpdate===!1)continue;i.copy(X.mapSize);let ot=X.getFrameExtents();if(i.multiply(ot),r.copy(X.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(r.x=Math.floor(h/ot.x),i.x=r.x*ot.x,X.mapSize.x=r.x),i.y>h&&(r.y=Math.floor(h/ot.y),i.y=r.y*ot.y,X.mapSize.y=r.y)),X.map===null||z===!0||B===!0){let mt=this.type!==Un?{minFilter:De,magFilter:De}:{};X.map!==null&&X.map.dispose(),X.map=new Wn(i.x,i.y,mt),X.map.texture.name=J.name+".shadowMap",X.camera.updateProjectionMatrix()}s.setRenderTarget(X.map),s.clear();let at=X.getViewportCount();for(let mt=0;mt<at;mt++){let Ut=X.getViewport(mt);o.set(r.x*Ut.x,r.y*Ut.y,r.x*Ut.z,r.y*Ut.w),k.viewport(o),X.updateMatrices(J,mt),n=X.getFrustum(),S(E,C,X.camera,J,this.type)}X.isPointLightShadow!==!0&&this.type===Un&&M(X,C),X.needsUpdate=!1}p=this.type,m.needsUpdate=!1,s.setRenderTarget(F,y,w)};function M(T,E){let C=t.update(_);d.defines.VSM_SAMPLES!==T.blurSamples&&(d.defines.VSM_SAMPLES=T.blurSamples,f.defines.VSM_SAMPLES=T.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new Wn(i.x,i.y)),d.uniforms.shadow_pass.value=T.map.texture,d.uniforms.resolution.value=T.mapSize,d.uniforms.radius.value=T.radius,s.setRenderTarget(T.mapPass),s.clear(),s.renderBufferDirect(E,null,C,d,_,null),f.uniforms.shadow_pass.value=T.mapPass.texture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,s.setRenderTarget(T.map),s.clear(),s.renderBufferDirect(E,null,C,f,_,null)}function v(T,E,C,F){let y=null,w=C.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(w!==void 0)y=w;else if(y=C.isPointLight===!0?c:a,s.localClippingEnabled&&E.clipShadows===!0&&Array.isArray(E.clippingPlanes)&&E.clippingPlanes.length!==0||E.displacementMap&&E.displacementScale!==0||E.alphaMap&&E.alphaTest>0||E.map&&E.alphaTest>0){let k=y.uuid,z=E.uuid,B=l[k];B===void 0&&(B={},l[k]=B);let Y=B[z];Y===void 0&&(Y=y.clone(),B[z]=Y,E.addEventListener("dispose",P)),y=Y}if(y.visible=E.visible,y.wireframe=E.wireframe,F===Un?y.side=E.shadowSide!==null?E.shadowSide:E.side:y.side=E.shadowSide!==null?E.shadowSide:u[E.side],y.alphaMap=E.alphaMap,y.alphaTest=E.alphaTest,y.map=E.map,y.clipShadows=E.clipShadows,y.clippingPlanes=E.clippingPlanes,y.clipIntersection=E.clipIntersection,y.displacementMap=E.displacementMap,y.displacementScale=E.displacementScale,y.displacementBias=E.displacementBias,y.wireframeLinewidth=E.wireframeLinewidth,y.linewidth=E.linewidth,C.isPointLight===!0&&y.isMeshDistanceMaterial===!0){let k=s.properties.get(y);k.light=C}return y}function S(T,E,C,F,y){if(T.visible===!1)return;if(T.layers.test(E.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&y===Un)&&(!T.frustumCulled||n.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(C.matrixWorldInverse,T.matrixWorld);let z=t.update(T),B=T.material;if(Array.isArray(B)){let Y=z.groups;for(let H=0,J=Y.length;H<J;H++){let X=Y[H],ot=B[X.materialIndex];if(ot&&ot.visible){let at=v(T,ot,F,y);T.onBeforeShadow(s,T,E,C,z,at,X),s.renderBufferDirect(C,null,z,at,T,X),T.onAfterShadow(s,T,E,C,z,at,X)}}}else if(B.visible){let Y=v(T,B,F,y);T.onBeforeShadow(s,T,E,C,z,Y,null),s.renderBufferDirect(C,null,z,Y,T,null),T.onAfterShadow(s,T,E,C,z,Y,null)}}let k=T.children;for(let z=0,B=k.length;z<B;z++)S(k[z],E,C,F,y)}function P(T){T.target.removeEventListener("dispose",P);for(let C in l){let F=l[C],y=T.target.uuid;y in F&&(F[y].dispose(),delete F[y])}}}var W_={[Ya]:Ka,[Za]:Ja,[ja]:Qa,[gs]:$a,[Ka]:Ya,[Ja]:Za,[Qa]:ja,[$a]:gs};function X_(s){function t(){let N=!1,ct=new qt,q=null,j=new qt(0,0,0,0);return{setMask:function(lt){q!==lt&&!N&&(s.colorMask(lt,lt,lt,lt),q=lt)},setLocked:function(lt){N=lt},setClear:function(lt,pt,Zt,_e,Ve){Ve===!0&&(lt*=_e,pt*=_e,Zt*=_e),ct.set(lt,pt,Zt,_e),j.equals(ct)===!1&&(s.clearColor(lt,pt,Zt,_e),j.copy(ct))},reset:function(){N=!1,q=null,j.set(-1,0,0,0)}}}function e(){let N=!1,ct=!1,q=null,j=null,lt=null;return{setReversed:function(pt){ct=pt},setTest:function(pt){pt?ut(s.DEPTH_TEST):ft(s.DEPTH_TEST)},setMask:function(pt){q!==pt&&!N&&(s.depthMask(pt),q=pt)},setFunc:function(pt){if(ct&&(pt=W_[pt]),j!==pt){switch(pt){case Ya:s.depthFunc(s.NEVER);break;case Ka:s.depthFunc(s.ALWAYS);break;case Za:s.depthFunc(s.LESS);break;case gs:s.depthFunc(s.LEQUAL);break;case ja:s.depthFunc(s.EQUAL);break;case $a:s.depthFunc(s.GEQUAL);break;case Ja:s.depthFunc(s.GREATER);break;case Qa:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}j=pt}},setLocked:function(pt){N=pt},setClear:function(pt){lt!==pt&&(s.clearDepth(pt),lt=pt)},reset:function(){N=!1,q=null,j=null,lt=null}}}function n(){let N=!1,ct=null,q=null,j=null,lt=null,pt=null,Zt=null,_e=null,Ve=null;return{setTest:function(Qt){N||(Qt?ut(s.STENCIL_TEST):ft(s.STENCIL_TEST))},setMask:function(Qt){ct!==Qt&&!N&&(s.stencilMask(Qt),ct=Qt)},setFunc:function(Qt,Ge,Pn){(q!==Qt||j!==Ge||lt!==Pn)&&(s.stencilFunc(Qt,Ge,Pn),q=Qt,j=Ge,lt=Pn)},setOp:function(Qt,Ge,Pn){(pt!==Qt||Zt!==Ge||_e!==Pn)&&(s.stencilOp(Qt,Ge,Pn),pt=Qt,Zt=Ge,_e=Pn)},setLocked:function(Qt){N=Qt},setClear:function(Qt){Ve!==Qt&&(s.clearStencil(Qt),Ve=Qt)},reset:function(){N=!1,ct=null,q=null,j=null,lt=null,pt=null,Zt=null,_e=null,Ve=null}}}let i=new t,r=new e,o=new n,a=new WeakMap,c=new WeakMap,l={},h={},u=new WeakMap,d=[],f=null,g=!1,_=null,m=null,p=null,M=null,v=null,S=null,P=null,T=new st(0,0,0),E=0,C=!1,F=null,y=null,w=null,k=null,z=null,B=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS),Y=!1,H=0,J=s.getParameter(s.VERSION);J.indexOf("WebGL")!==-1?(H=parseFloat(/^WebGL (\d)/.exec(J)[1]),Y=H>=1):J.indexOf("OpenGL ES")!==-1&&(H=parseFloat(/^OpenGL ES (\d)/.exec(J)[1]),Y=H>=2);let X=null,ot={},at=s.getParameter(s.SCISSOR_BOX),mt=s.getParameter(s.VIEWPORT),Ut=new qt().fromArray(at),Yt=new qt().fromArray(mt);function Z(N,ct,q,j){let lt=new Uint8Array(4),pt=s.createTexture();s.bindTexture(N,pt),s.texParameteri(N,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(N,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let Zt=0;Zt<q;Zt++)N===s.TEXTURE_3D||N===s.TEXTURE_2D_ARRAY?s.texImage3D(ct,0,s.RGBA,1,1,j,0,s.RGBA,s.UNSIGNED_BYTE,lt):s.texImage2D(ct+Zt,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,lt);return pt}let Q={};Q[s.TEXTURE_2D]=Z(s.TEXTURE_2D,s.TEXTURE_2D,1),Q[s.TEXTURE_CUBE_MAP]=Z(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),Q[s.TEXTURE_2D_ARRAY]=Z(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),Q[s.TEXTURE_3D]=Z(s.TEXTURE_3D,s.TEXTURE_3D,1,1),i.setClear(0,0,0,1),r.setClear(1),o.setClear(0),ut(s.DEPTH_TEST),r.setFunc(gs),Vt(!1),Ft(Sh),ut(s.CULL_FACE),I(ci);function ut(N){l[N]!==!0&&(s.enable(N),l[N]=!0)}function ft(N){l[N]!==!1&&(s.disable(N),l[N]=!1)}function Lt(N,ct){return h[N]!==ct?(s.bindFramebuffer(N,ct),h[N]=ct,N===s.DRAW_FRAMEBUFFER&&(h[s.FRAMEBUFFER]=ct),N===s.FRAMEBUFFER&&(h[s.DRAW_FRAMEBUFFER]=ct),!0):!1}function vt(N,ct){let q=d,j=!1;if(N){q=u.get(ct),q===void 0&&(q=[],u.set(ct,q));let lt=N.textures;if(q.length!==lt.length||q[0]!==s.COLOR_ATTACHMENT0){for(let pt=0,Zt=lt.length;pt<Zt;pt++)q[pt]=s.COLOR_ATTACHMENT0+pt;q.length=lt.length,j=!0}}else q[0]!==s.BACK&&(q[0]=s.BACK,j=!0);j&&s.drawBuffers(q)}function Ot(N){return f!==N?(s.useProgram(N),f=N,!0):!1}let Kt={[Ri]:s.FUNC_ADD,[nf]:s.FUNC_SUBTRACT,[sf]:s.FUNC_REVERSE_SUBTRACT};Kt[rf]=s.MIN,Kt[of]=s.MAX;let Ht={[af]:s.ZERO,[cf]:s.ONE,[lf]:s.SRC_COLOR,[Xa]:s.SRC_ALPHA,[mf]:s.SRC_ALPHA_SATURATE,[ff]:s.DST_COLOR,[uf]:s.DST_ALPHA,[hf]:s.ONE_MINUS_SRC_COLOR,[qa]:s.ONE_MINUS_SRC_ALPHA,[pf]:s.ONE_MINUS_DST_COLOR,[df]:s.ONE_MINUS_DST_ALPHA,[gf]:s.CONSTANT_COLOR,[_f]:s.ONE_MINUS_CONSTANT_COLOR,[xf]:s.CONSTANT_ALPHA,[yf]:s.ONE_MINUS_CONSTANT_ALPHA};function I(N,ct,q,j,lt,pt,Zt,_e,Ve,Qt){if(N===ci){g===!0&&(ft(s.BLEND),g=!1);return}if(g===!1&&(ut(s.BLEND),g=!0),N!==ef){if(N!==_||Qt!==C){if((m!==Ri||v!==Ri)&&(s.blendEquation(s.FUNC_ADD),m=Ri,v=Ri),Qt)switch(N){case ds:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Hn:s.blendFunc(s.ONE,s.ONE);break;case bh:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case oo:s.blendFuncSeparate(s.ZERO,s.SRC_COLOR,s.ZERO,s.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}else switch(N){case ds:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Hn:s.blendFunc(s.SRC_ALPHA,s.ONE);break;case bh:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case oo:s.blendFunc(s.ZERO,s.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}p=null,M=null,S=null,P=null,T.set(0,0,0),E=0,_=N,C=Qt}return}lt=lt||ct,pt=pt||q,Zt=Zt||j,(ct!==m||lt!==v)&&(s.blendEquationSeparate(Kt[ct],Kt[lt]),m=ct,v=lt),(q!==p||j!==M||pt!==S||Zt!==P)&&(s.blendFuncSeparate(Ht[q],Ht[j],Ht[pt],Ht[Zt]),p=q,M=j,S=pt,P=Zt),(_e.equals(T)===!1||Ve!==E)&&(s.blendColor(_e.r,_e.g,_e.b,Ve),T.copy(_e),E=Ve),_=N,C=!1}function ke(N,ct){N.side===ve?ft(s.CULL_FACE):ut(s.CULL_FACE);let q=N.side===Ne;ct&&(q=!q),Vt(q),N.blending===ds&&N.transparent===!1?I(ci):I(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),r.setFunc(N.depthFunc),r.setTest(N.depthTest),r.setMask(N.depthWrite),i.setMask(N.colorWrite);let j=N.stencilWrite;o.setTest(j),j&&(o.setMask(N.stencilWriteMask),o.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),o.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),ie(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?ut(s.SAMPLE_ALPHA_TO_COVERAGE):ft(s.SAMPLE_ALPHA_TO_COVERAGE)}function Vt(N){F!==N&&(N?s.frontFace(s.CW):s.frontFace(s.CCW),F=N)}function Ft(N){N!==Qd?(ut(s.CULL_FACE),N!==y&&(N===Sh?s.cullFace(s.BACK):N===tf?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):ft(s.CULL_FACE),y=N}function At(N){N!==w&&(Y&&s.lineWidth(N),w=N)}function ie(N,ct,q){N?(ut(s.POLYGON_OFFSET_FILL),(k!==ct||z!==q)&&(s.polygonOffset(ct,q),k=ct,z=q)):ft(s.POLYGON_OFFSET_FILL)}function Ct(N){N?ut(s.SCISSOR_TEST):ft(s.SCISSOR_TEST)}function R(N){N===void 0&&(N=s.TEXTURE0+B-1),X!==N&&(s.activeTexture(N),X=N)}function x(N,ct,q){q===void 0&&(X===null?q=s.TEXTURE0+B-1:q=X);let j=ot[q];j===void 0&&(j={type:void 0,texture:void 0},ot[q]=j),(j.type!==N||j.texture!==ct)&&(X!==q&&(s.activeTexture(q),X=q),s.bindTexture(N,ct||Q[N]),j.type=N,j.texture=ct)}function D(){let N=ot[X];N!==void 0&&N.type!==void 0&&(s.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function L(){try{s.compressedTexImage2D.apply(s,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function K(){try{s.compressedTexImage3D.apply(s,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function W(){try{s.texSubImage2D.apply(s,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function it(){try{s.texSubImage3D.apply(s,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function tt(){try{s.compressedTexSubImage2D.apply(s,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function nt(){try{s.compressedTexSubImage3D.apply(s,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function _t(){try{s.texStorage2D.apply(s,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function $(){try{s.texStorage3D.apply(s,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function gt(){try{s.texImage2D.apply(s,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Pt(){try{s.texImage3D.apply(s,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Et(N){Ut.equals(N)===!1&&(s.scissor(N.x,N.y,N.z,N.w),Ut.copy(N))}function dt(N){Yt.equals(N)===!1&&(s.viewport(N.x,N.y,N.z,N.w),Yt.copy(N))}function Gt(N,ct){let q=c.get(ct);q===void 0&&(q=new WeakMap,c.set(ct,q));let j=q.get(N);j===void 0&&(j=s.getUniformBlockIndex(ct,N.name),q.set(N,j))}function zt(N,ct){let j=c.get(ct).get(N);a.get(ct)!==j&&(s.uniformBlockBinding(ct,j,N.__bindingPointIndex),a.set(ct,j))}function Jt(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),l={},X=null,ot={},h={},u=new WeakMap,d=[],f=null,g=!1,_=null,m=null,p=null,M=null,v=null,S=null,P=null,T=new st(0,0,0),E=0,C=!1,F=null,y=null,w=null,k=null,z=null,Ut.set(0,0,s.canvas.width,s.canvas.height),Yt.set(0,0,s.canvas.width,s.canvas.height),i.reset(),r.reset(),o.reset()}return{buffers:{color:i,depth:r,stencil:o},enable:ut,disable:ft,bindFramebuffer:Lt,drawBuffers:vt,useProgram:Ot,setBlending:I,setMaterial:ke,setFlipSided:Vt,setCullFace:Ft,setLineWidth:At,setPolygonOffset:ie,setScissorTest:Ct,activeTexture:R,bindTexture:x,unbindTexture:D,compressedTexImage2D:L,compressedTexImage3D:K,texImage2D:gt,texImage3D:Pt,updateUBOMapping:Gt,uniformBlockBinding:zt,texStorage2D:_t,texStorage3D:$,texSubImage2D:W,texSubImage3D:it,compressedTexSubImage2D:tt,compressedTexSubImage3D:nt,scissor:Et,viewport:dt,reset:Jt}}function pu(s,t,e,n){let i=q_(n);switch(e){case Vu:return s*t;case Wu:return s*t;case Xu:return s*t*2;case pl:return s*t/i.components*i.byteLength;case ml:return s*t/i.components*i.byteLength;case qu:return s*t*2/i.components*i.byteLength;case gl:return s*t*2/i.components*i.byteLength;case Gu:return s*t*3/i.components*i.byteLength;case an:return s*t*4/i.components*i.byteLength;case _l:return s*t*4/i.components*i.byteLength;case to:case eo:return Math.floor((s+3)/4)*Math.floor((t+3)/4)*8;case no:case io:return Math.floor((s+3)/4)*Math.floor((t+3)/4)*16;case nc:case sc:return Math.max(s,16)*Math.max(t,8)/4;case ec:case ic:return Math.max(s,8)*Math.max(t,8)/2;case rc:case oc:return Math.floor((s+3)/4)*Math.floor((t+3)/4)*8;case ac:return Math.floor((s+3)/4)*Math.floor((t+3)/4)*16;case cc:return Math.floor((s+3)/4)*Math.floor((t+3)/4)*16;case lc:return Math.floor((s+4)/5)*Math.floor((t+3)/4)*16;case hc:return Math.floor((s+4)/5)*Math.floor((t+4)/5)*16;case uc:return Math.floor((s+5)/6)*Math.floor((t+4)/5)*16;case dc:return Math.floor((s+5)/6)*Math.floor((t+5)/6)*16;case fc:return Math.floor((s+7)/8)*Math.floor((t+4)/5)*16;case pc:return Math.floor((s+7)/8)*Math.floor((t+5)/6)*16;case mc:return Math.floor((s+7)/8)*Math.floor((t+7)/8)*16;case gc:return Math.floor((s+9)/10)*Math.floor((t+4)/5)*16;case _c:return Math.floor((s+9)/10)*Math.floor((t+5)/6)*16;case xc:return Math.floor((s+9)/10)*Math.floor((t+7)/8)*16;case yc:return Math.floor((s+9)/10)*Math.floor((t+9)/10)*16;case vc:return Math.floor((s+11)/12)*Math.floor((t+9)/10)*16;case Mc:return Math.floor((s+11)/12)*Math.floor((t+11)/12)*16;case so:case wc:case Sc:return Math.ceil(s/4)*Math.ceil(t/4)*16;case Yu:case bc:return Math.ceil(s/4)*Math.ceil(t/4)*8;case Ac:case Tc:return Math.ceil(s/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${e} format.`)}function q_(s){switch(s){case Vn:case Fu:return{byteLength:1,components:1};case sr:case Bu:case fr:return{byteLength:2,components:1};case dl:case fl:return{byteLength:2,components:4};case Ii:case ul:case vn:return{byteLength:4,components:1};case Hu:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${s}.`)}function Y_(s,t,e,n,i,r,o){let a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new bt,h=new WeakMap,u,d=new WeakMap,f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(R,x){return f?new OffscreenCanvas(R,x):rr("canvas")}function _(R,x,D){let L=1,K=Ct(R);if((K.width>D||K.height>D)&&(L=D/Math.max(K.width,K.height)),L<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){let W=Math.floor(L*K.width),it=Math.floor(L*K.height);u===void 0&&(u=g(W,it));let tt=x?g(W,it):u;return tt.width=W,tt.height=it,tt.getContext("2d").drawImage(R,0,0,W,it),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+K.width+"x"+K.height+") to ("+W+"x"+it+")."),tt}else return"data"in R&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+K.width+"x"+K.height+")."),R;return R}function m(R){return R.generateMipmaps&&R.minFilter!==De&&R.minFilter!==We}function p(R){s.generateMipmap(R)}function M(R,x,D,L,K=!1){if(R!==null){if(s[R]!==void 0)return s[R];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let W=x;if(x===s.RED&&(D===s.FLOAT&&(W=s.R32F),D===s.HALF_FLOAT&&(W=s.R16F),D===s.UNSIGNED_BYTE&&(W=s.R8)),x===s.RED_INTEGER&&(D===s.UNSIGNED_BYTE&&(W=s.R8UI),D===s.UNSIGNED_SHORT&&(W=s.R16UI),D===s.UNSIGNED_INT&&(W=s.R32UI),D===s.BYTE&&(W=s.R8I),D===s.SHORT&&(W=s.R16I),D===s.INT&&(W=s.R32I)),x===s.RG&&(D===s.FLOAT&&(W=s.RG32F),D===s.HALF_FLOAT&&(W=s.RG16F),D===s.UNSIGNED_BYTE&&(W=s.RG8)),x===s.RG_INTEGER&&(D===s.UNSIGNED_BYTE&&(W=s.RG8UI),D===s.UNSIGNED_SHORT&&(W=s.RG16UI),D===s.UNSIGNED_INT&&(W=s.RG32UI),D===s.BYTE&&(W=s.RG8I),D===s.SHORT&&(W=s.RG16I),D===s.INT&&(W=s.RG32I)),x===s.RGB_INTEGER&&(D===s.UNSIGNED_BYTE&&(W=s.RGB8UI),D===s.UNSIGNED_SHORT&&(W=s.RGB16UI),D===s.UNSIGNED_INT&&(W=s.RGB32UI),D===s.BYTE&&(W=s.RGB8I),D===s.SHORT&&(W=s.RGB16I),D===s.INT&&(W=s.RGB32I)),x===s.RGBA_INTEGER&&(D===s.UNSIGNED_BYTE&&(W=s.RGBA8UI),D===s.UNSIGNED_SHORT&&(W=s.RGBA16UI),D===s.UNSIGNED_INT&&(W=s.RGBA32UI),D===s.BYTE&&(W=s.RGBA8I),D===s.SHORT&&(W=s.RGBA16I),D===s.INT&&(W=s.RGBA32I)),x===s.RGB&&D===s.UNSIGNED_INT_5_9_9_9_REV&&(W=s.RGB9_E5),x===s.RGBA){let it=K?co:jt.getTransfer(L);D===s.FLOAT&&(W=s.RGBA32F),D===s.HALF_FLOAT&&(W=s.RGBA16F),D===s.UNSIGNED_BYTE&&(W=it===le?s.SRGB8_ALPHA8:s.RGBA8),D===s.UNSIGNED_SHORT_4_4_4_4&&(W=s.RGBA4),D===s.UNSIGNED_SHORT_5_5_5_1&&(W=s.RGB5_A1)}return(W===s.R16F||W===s.R32F||W===s.RG16F||W===s.RG32F||W===s.RGBA16F||W===s.RGBA32F)&&t.get("EXT_color_buffer_float"),W}function v(R,x){let D;return R?x===null||x===Ii||x===ys?D=s.DEPTH24_STENCIL8:x===vn?D=s.DEPTH32F_STENCIL8:x===sr&&(D=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===Ii||x===ys?D=s.DEPTH_COMPONENT24:x===vn?D=s.DEPTH_COMPONENT32F:x===sr&&(D=s.DEPTH_COMPONENT16),D}function S(R,x){return m(R)===!0||R.isFramebufferTexture&&R.minFilter!==De&&R.minFilter!==We?Math.log2(Math.max(x.width,x.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?x.mipmaps.length:1}function P(R){let x=R.target;x.removeEventListener("dispose",P),E(x),x.isVideoTexture&&h.delete(x)}function T(R){let x=R.target;x.removeEventListener("dispose",T),F(x)}function E(R){let x=n.get(R);if(x.__webglInit===void 0)return;let D=R.source,L=d.get(D);if(L){let K=L[x.__cacheKey];K.usedTimes--,K.usedTimes===0&&C(R),Object.keys(L).length===0&&d.delete(D)}n.remove(R)}function C(R){let x=n.get(R);s.deleteTexture(x.__webglTexture);let D=R.source,L=d.get(D);delete L[x.__cacheKey],o.memory.textures--}function F(R){let x=n.get(R);if(R.depthTexture&&R.depthTexture.dispose(),R.isWebGLCubeRenderTarget)for(let L=0;L<6;L++){if(Array.isArray(x.__webglFramebuffer[L]))for(let K=0;K<x.__webglFramebuffer[L].length;K++)s.deleteFramebuffer(x.__webglFramebuffer[L][K]);else s.deleteFramebuffer(x.__webglFramebuffer[L]);x.__webglDepthbuffer&&s.deleteRenderbuffer(x.__webglDepthbuffer[L])}else{if(Array.isArray(x.__webglFramebuffer))for(let L=0;L<x.__webglFramebuffer.length;L++)s.deleteFramebuffer(x.__webglFramebuffer[L]);else s.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&s.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&s.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let L=0;L<x.__webglColorRenderbuffer.length;L++)x.__webglColorRenderbuffer[L]&&s.deleteRenderbuffer(x.__webglColorRenderbuffer[L]);x.__webglDepthRenderbuffer&&s.deleteRenderbuffer(x.__webglDepthRenderbuffer)}let D=R.textures;for(let L=0,K=D.length;L<K;L++){let W=n.get(D[L]);W.__webglTexture&&(s.deleteTexture(W.__webglTexture),o.memory.textures--),n.remove(D[L])}n.remove(R)}let y=0;function w(){y=0}function k(){let R=y;return R>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+R+" texture units while this GPU supports only "+i.maxTextures),y+=1,R}function z(R){let x=[];return x.push(R.wrapS),x.push(R.wrapT),x.push(R.wrapR||0),x.push(R.magFilter),x.push(R.minFilter),x.push(R.anisotropy),x.push(R.internalFormat),x.push(R.format),x.push(R.type),x.push(R.generateMipmaps),x.push(R.premultiplyAlpha),x.push(R.flipY),x.push(R.unpackAlignment),x.push(R.colorSpace),x.join()}function B(R,x){let D=n.get(R);if(R.isVideoTexture&&At(R),R.isRenderTargetTexture===!1&&R.version>0&&D.__version!==R.version){let L=R.image;if(L===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(L.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Yt(D,R,x);return}}e.bindTexture(s.TEXTURE_2D,D.__webglTexture,s.TEXTURE0+x)}function Y(R,x){let D=n.get(R);if(R.version>0&&D.__version!==R.version){Yt(D,R,x);return}e.bindTexture(s.TEXTURE_2D_ARRAY,D.__webglTexture,s.TEXTURE0+x)}function H(R,x){let D=n.get(R);if(R.version>0&&D.__version!==R.version){Yt(D,R,x);return}e.bindTexture(s.TEXTURE_3D,D.__webglTexture,s.TEXTURE0+x)}function J(R,x){let D=n.get(R);if(R.version>0&&D.__version!==R.version){Z(D,R,x);return}e.bindTexture(s.TEXTURE_CUBE_MAP,D.__webglTexture,s.TEXTURE0+x)}let X={[Tn]:s.REPEAT,[Fn]:s.CLAMP_TO_EDGE,[ir]:s.MIRRORED_REPEAT},ot={[De]:s.NEAREST,[hl]:s.NEAREST_MIPMAP_NEAREST,[cs]:s.NEAREST_MIPMAP_LINEAR,[We]:s.LINEAR,[Js]:s.LINEAR_MIPMAP_NEAREST,[bn]:s.LINEAR_MIPMAP_LINEAR},at={[Df]:s.NEVER,[Bf]:s.ALWAYS,[Nf]:s.LESS,[ju]:s.LEQUAL,[kf]:s.EQUAL,[Ff]:s.GEQUAL,[Uf]:s.GREATER,[Of]:s.NOTEQUAL};function mt(R,x){if(x.type===vn&&t.has("OES_texture_float_linear")===!1&&(x.magFilter===We||x.magFilter===Js||x.magFilter===cs||x.magFilter===bn||x.minFilter===We||x.minFilter===Js||x.minFilter===cs||x.minFilter===bn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(R,s.TEXTURE_WRAP_S,X[x.wrapS]),s.texParameteri(R,s.TEXTURE_WRAP_T,X[x.wrapT]),(R===s.TEXTURE_3D||R===s.TEXTURE_2D_ARRAY)&&s.texParameteri(R,s.TEXTURE_WRAP_R,X[x.wrapR]),s.texParameteri(R,s.TEXTURE_MAG_FILTER,ot[x.magFilter]),s.texParameteri(R,s.TEXTURE_MIN_FILTER,ot[x.minFilter]),x.compareFunction&&(s.texParameteri(R,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(R,s.TEXTURE_COMPARE_FUNC,at[x.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===De||x.minFilter!==cs&&x.minFilter!==bn||x.type===vn&&t.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||n.get(x).__currentAnisotropy){let D=t.get("EXT_texture_filter_anisotropic");s.texParameterf(R,D.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,i.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy}}}function Ut(R,x){let D=!1;R.__webglInit===void 0&&(R.__webglInit=!0,x.addEventListener("dispose",P));let L=x.source,K=d.get(L);K===void 0&&(K={},d.set(L,K));let W=z(x);if(W!==R.__cacheKey){K[W]===void 0&&(K[W]={texture:s.createTexture(),usedTimes:0},o.memory.textures++,D=!0),K[W].usedTimes++;let it=K[R.__cacheKey];it!==void 0&&(K[R.__cacheKey].usedTimes--,it.usedTimes===0&&C(x)),R.__cacheKey=W,R.__webglTexture=K[W].texture}return D}function Yt(R,x,D){let L=s.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(L=s.TEXTURE_2D_ARRAY),x.isData3DTexture&&(L=s.TEXTURE_3D);let K=Ut(R,x),W=x.source;e.bindTexture(L,R.__webglTexture,s.TEXTURE0+D);let it=n.get(W);if(W.version!==it.__version||K===!0){e.activeTexture(s.TEXTURE0+D);let tt=jt.getPrimaries(jt.workingColorSpace),nt=x.colorSpace===ri?null:jt.getPrimaries(x.colorSpace),_t=x.colorSpace===ri||tt===nt?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,x.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,x.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,_t);let $=_(x.image,!1,i.maxTextureSize);$=ie(x,$);let gt=r.convert(x.format,x.colorSpace),Pt=r.convert(x.type),Et=M(x.internalFormat,gt,Pt,x.colorSpace,x.isVideoTexture);mt(L,x);let dt,Gt=x.mipmaps,zt=x.isVideoTexture!==!0,Jt=it.__version===void 0||K===!0,N=W.dataReady,ct=S(x,$);if(x.isDepthTexture)Et=v(x.format===vs,x.type),Jt&&(zt?e.texStorage2D(s.TEXTURE_2D,1,Et,$.width,$.height):e.texImage2D(s.TEXTURE_2D,0,Et,$.width,$.height,0,gt,Pt,null));else if(x.isDataTexture)if(Gt.length>0){zt&&Jt&&e.texStorage2D(s.TEXTURE_2D,ct,Et,Gt[0].width,Gt[0].height);for(let q=0,j=Gt.length;q<j;q++)dt=Gt[q],zt?N&&e.texSubImage2D(s.TEXTURE_2D,q,0,0,dt.width,dt.height,gt,Pt,dt.data):e.texImage2D(s.TEXTURE_2D,q,Et,dt.width,dt.height,0,gt,Pt,dt.data);x.generateMipmaps=!1}else zt?(Jt&&e.texStorage2D(s.TEXTURE_2D,ct,Et,$.width,$.height),N&&e.texSubImage2D(s.TEXTURE_2D,0,0,0,$.width,$.height,gt,Pt,$.data)):e.texImage2D(s.TEXTURE_2D,0,Et,$.width,$.height,0,gt,Pt,$.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){zt&&Jt&&e.texStorage3D(s.TEXTURE_2D_ARRAY,ct,Et,Gt[0].width,Gt[0].height,$.depth);for(let q=0,j=Gt.length;q<j;q++)if(dt=Gt[q],x.format!==an)if(gt!==null)if(zt){if(N)if(x.layerUpdates.size>0){let lt=pu(dt.width,dt.height,x.format,x.type);for(let pt of x.layerUpdates){let Zt=dt.data.subarray(pt*lt/dt.data.BYTES_PER_ELEMENT,(pt+1)*lt/dt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,q,0,0,pt,dt.width,dt.height,1,gt,Zt,0,0)}x.clearLayerUpdates()}else e.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,q,0,0,0,dt.width,dt.height,$.depth,gt,dt.data,0,0)}else e.compressedTexImage3D(s.TEXTURE_2D_ARRAY,q,Et,dt.width,dt.height,$.depth,0,dt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else zt?N&&e.texSubImage3D(s.TEXTURE_2D_ARRAY,q,0,0,0,dt.width,dt.height,$.depth,gt,Pt,dt.data):e.texImage3D(s.TEXTURE_2D_ARRAY,q,Et,dt.width,dt.height,$.depth,0,gt,Pt,dt.data)}else{zt&&Jt&&e.texStorage2D(s.TEXTURE_2D,ct,Et,Gt[0].width,Gt[0].height);for(let q=0,j=Gt.length;q<j;q++)dt=Gt[q],x.format!==an?gt!==null?zt?N&&e.compressedTexSubImage2D(s.TEXTURE_2D,q,0,0,dt.width,dt.height,gt,dt.data):e.compressedTexImage2D(s.TEXTURE_2D,q,Et,dt.width,dt.height,0,dt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):zt?N&&e.texSubImage2D(s.TEXTURE_2D,q,0,0,dt.width,dt.height,gt,Pt,dt.data):e.texImage2D(s.TEXTURE_2D,q,Et,dt.width,dt.height,0,gt,Pt,dt.data)}else if(x.isDataArrayTexture)if(zt){if(Jt&&e.texStorage3D(s.TEXTURE_2D_ARRAY,ct,Et,$.width,$.height,$.depth),N)if(x.layerUpdates.size>0){let q=pu($.width,$.height,x.format,x.type);for(let j of x.layerUpdates){let lt=$.data.subarray(j*q/$.data.BYTES_PER_ELEMENT,(j+1)*q/$.data.BYTES_PER_ELEMENT);e.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,j,$.width,$.height,1,gt,Pt,lt)}x.clearLayerUpdates()}else e.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,$.width,$.height,$.depth,gt,Pt,$.data)}else e.texImage3D(s.TEXTURE_2D_ARRAY,0,Et,$.width,$.height,$.depth,0,gt,Pt,$.data);else if(x.isData3DTexture)zt?(Jt&&e.texStorage3D(s.TEXTURE_3D,ct,Et,$.width,$.height,$.depth),N&&e.texSubImage3D(s.TEXTURE_3D,0,0,0,0,$.width,$.height,$.depth,gt,Pt,$.data)):e.texImage3D(s.TEXTURE_3D,0,Et,$.width,$.height,$.depth,0,gt,Pt,$.data);else if(x.isFramebufferTexture){if(Jt)if(zt)e.texStorage2D(s.TEXTURE_2D,ct,Et,$.width,$.height);else{let q=$.width,j=$.height;for(let lt=0;lt<ct;lt++)e.texImage2D(s.TEXTURE_2D,lt,Et,q,j,0,gt,Pt,null),q>>=1,j>>=1}}else if(Gt.length>0){if(zt&&Jt){let q=Ct(Gt[0]);e.texStorage2D(s.TEXTURE_2D,ct,Et,q.width,q.height)}for(let q=0,j=Gt.length;q<j;q++)dt=Gt[q],zt?N&&e.texSubImage2D(s.TEXTURE_2D,q,0,0,gt,Pt,dt):e.texImage2D(s.TEXTURE_2D,q,Et,gt,Pt,dt);x.generateMipmaps=!1}else if(zt){if(Jt){let q=Ct($);e.texStorage2D(s.TEXTURE_2D,ct,Et,q.width,q.height)}N&&e.texSubImage2D(s.TEXTURE_2D,0,0,0,gt,Pt,$)}else e.texImage2D(s.TEXTURE_2D,0,Et,gt,Pt,$);m(x)&&p(L),it.__version=W.version,x.onUpdate&&x.onUpdate(x)}R.__version=x.version}function Z(R,x,D){if(x.image.length!==6)return;let L=Ut(R,x),K=x.source;e.bindTexture(s.TEXTURE_CUBE_MAP,R.__webglTexture,s.TEXTURE0+D);let W=n.get(K);if(K.version!==W.__version||L===!0){e.activeTexture(s.TEXTURE0+D);let it=jt.getPrimaries(jt.workingColorSpace),tt=x.colorSpace===ri?null:jt.getPrimaries(x.colorSpace),nt=x.colorSpace===ri||it===tt?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,x.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,x.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,nt);let _t=x.isCompressedTexture||x.image[0].isCompressedTexture,$=x.image[0]&&x.image[0].isDataTexture,gt=[];for(let j=0;j<6;j++)!_t&&!$?gt[j]=_(x.image[j],!0,i.maxCubemapSize):gt[j]=$?x.image[j].image:x.image[j],gt[j]=ie(x,gt[j]);let Pt=gt[0],Et=r.convert(x.format,x.colorSpace),dt=r.convert(x.type),Gt=M(x.internalFormat,Et,dt,x.colorSpace),zt=x.isVideoTexture!==!0,Jt=W.__version===void 0||L===!0,N=K.dataReady,ct=S(x,Pt);mt(s.TEXTURE_CUBE_MAP,x);let q;if(_t){zt&&Jt&&e.texStorage2D(s.TEXTURE_CUBE_MAP,ct,Gt,Pt.width,Pt.height);for(let j=0;j<6;j++){q=gt[j].mipmaps;for(let lt=0;lt<q.length;lt++){let pt=q[lt];x.format!==an?Et!==null?zt?N&&e.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,lt,0,0,pt.width,pt.height,Et,pt.data):e.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,lt,Gt,pt.width,pt.height,0,pt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):zt?N&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,lt,0,0,pt.width,pt.height,Et,dt,pt.data):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,lt,Gt,pt.width,pt.height,0,Et,dt,pt.data)}}}else{if(q=x.mipmaps,zt&&Jt){q.length>0&&ct++;let j=Ct(gt[0]);e.texStorage2D(s.TEXTURE_CUBE_MAP,ct,Gt,j.width,j.height)}for(let j=0;j<6;j++)if($){zt?N&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,gt[j].width,gt[j].height,Et,dt,gt[j].data):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Gt,gt[j].width,gt[j].height,0,Et,dt,gt[j].data);for(let lt=0;lt<q.length;lt++){let Zt=q[lt].image[j].image;zt?N&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,lt+1,0,0,Zt.width,Zt.height,Et,dt,Zt.data):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,lt+1,Gt,Zt.width,Zt.height,0,Et,dt,Zt.data)}}else{zt?N&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,Et,dt,gt[j]):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Gt,Et,dt,gt[j]);for(let lt=0;lt<q.length;lt++){let pt=q[lt];zt?N&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,lt+1,0,0,Et,dt,pt.image[j]):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,lt+1,Gt,Et,dt,pt.image[j])}}}m(x)&&p(s.TEXTURE_CUBE_MAP),W.__version=K.version,x.onUpdate&&x.onUpdate(x)}R.__version=x.version}function Q(R,x,D,L,K,W){let it=r.convert(D.format,D.colorSpace),tt=r.convert(D.type),nt=M(D.internalFormat,it,tt,D.colorSpace);if(!n.get(x).__hasExternalTextures){let $=Math.max(1,x.width>>W),gt=Math.max(1,x.height>>W);K===s.TEXTURE_3D||K===s.TEXTURE_2D_ARRAY?e.texImage3D(K,W,nt,$,gt,x.depth,0,it,tt,null):e.texImage2D(K,W,nt,$,gt,0,it,tt,null)}e.bindFramebuffer(s.FRAMEBUFFER,R),Ft(x)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,L,K,n.get(D).__webglTexture,0,Vt(x)):(K===s.TEXTURE_2D||K>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&K<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,L,K,n.get(D).__webglTexture,W),e.bindFramebuffer(s.FRAMEBUFFER,null)}function ut(R,x,D){if(s.bindRenderbuffer(s.RENDERBUFFER,R),x.depthBuffer){let L=x.depthTexture,K=L&&L.isDepthTexture?L.type:null,W=v(x.stencilBuffer,K),it=x.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,tt=Vt(x);Ft(x)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,tt,W,x.width,x.height):D?s.renderbufferStorageMultisample(s.RENDERBUFFER,tt,W,x.width,x.height):s.renderbufferStorage(s.RENDERBUFFER,W,x.width,x.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,it,s.RENDERBUFFER,R)}else{let L=x.textures;for(let K=0;K<L.length;K++){let W=L[K],it=r.convert(W.format,W.colorSpace),tt=r.convert(W.type),nt=M(W.internalFormat,it,tt,W.colorSpace),_t=Vt(x);D&&Ft(x)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,_t,nt,x.width,x.height):Ft(x)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,_t,nt,x.width,x.height):s.renderbufferStorage(s.RENDERBUFFER,nt,x.width,x.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function ft(R,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(s.FRAMEBUFFER,R),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(x.depthTexture).__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),B(x.depthTexture,0);let L=n.get(x.depthTexture).__webglTexture,K=Vt(x);if(x.depthTexture.format===fs)Ft(x)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,L,0,K):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,L,0);else if(x.depthTexture.format===vs)Ft(x)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,L,0,K):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,L,0);else throw new Error("Unknown depthTexture format")}function Lt(R){let x=n.get(R),D=R.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==R.depthTexture){let L=R.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),L){let K=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,L.removeEventListener("dispose",K)};L.addEventListener("dispose",K),x.__depthDisposeCallback=K}x.__boundDepthTexture=L}if(R.depthTexture&&!x.__autoAllocateDepthBuffer){if(D)throw new Error("target.depthTexture not supported in Cube render targets");ft(x.__webglFramebuffer,R)}else if(D){x.__webglDepthbuffer=[];for(let L=0;L<6;L++)if(e.bindFramebuffer(s.FRAMEBUFFER,x.__webglFramebuffer[L]),x.__webglDepthbuffer[L]===void 0)x.__webglDepthbuffer[L]=s.createRenderbuffer(),ut(x.__webglDepthbuffer[L],R,!1);else{let K=R.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,W=x.__webglDepthbuffer[L];s.bindRenderbuffer(s.RENDERBUFFER,W),s.framebufferRenderbuffer(s.FRAMEBUFFER,K,s.RENDERBUFFER,W)}}else if(e.bindFramebuffer(s.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=s.createRenderbuffer(),ut(x.__webglDepthbuffer,R,!1);else{let L=R.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,K=x.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,K),s.framebufferRenderbuffer(s.FRAMEBUFFER,L,s.RENDERBUFFER,K)}e.bindFramebuffer(s.FRAMEBUFFER,null)}function vt(R,x,D){let L=n.get(R);x!==void 0&&Q(L.__webglFramebuffer,R,R.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),D!==void 0&&Lt(R)}function Ot(R){let x=R.texture,D=n.get(R),L=n.get(x);R.addEventListener("dispose",T);let K=R.textures,W=R.isWebGLCubeRenderTarget===!0,it=K.length>1;if(it||(L.__webglTexture===void 0&&(L.__webglTexture=s.createTexture()),L.__version=x.version,o.memory.textures++),W){D.__webglFramebuffer=[];for(let tt=0;tt<6;tt++)if(x.mipmaps&&x.mipmaps.length>0){D.__webglFramebuffer[tt]=[];for(let nt=0;nt<x.mipmaps.length;nt++)D.__webglFramebuffer[tt][nt]=s.createFramebuffer()}else D.__webglFramebuffer[tt]=s.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){D.__webglFramebuffer=[];for(let tt=0;tt<x.mipmaps.length;tt++)D.__webglFramebuffer[tt]=s.createFramebuffer()}else D.__webglFramebuffer=s.createFramebuffer();if(it)for(let tt=0,nt=K.length;tt<nt;tt++){let _t=n.get(K[tt]);_t.__webglTexture===void 0&&(_t.__webglTexture=s.createTexture(),o.memory.textures++)}if(R.samples>0&&Ft(R)===!1){D.__webglMultisampledFramebuffer=s.createFramebuffer(),D.__webglColorRenderbuffer=[],e.bindFramebuffer(s.FRAMEBUFFER,D.__webglMultisampledFramebuffer);for(let tt=0;tt<K.length;tt++){let nt=K[tt];D.__webglColorRenderbuffer[tt]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,D.__webglColorRenderbuffer[tt]);let _t=r.convert(nt.format,nt.colorSpace),$=r.convert(nt.type),gt=M(nt.internalFormat,_t,$,nt.colorSpace,R.isXRRenderTarget===!0),Pt=Vt(R);s.renderbufferStorageMultisample(s.RENDERBUFFER,Pt,gt,R.width,R.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+tt,s.RENDERBUFFER,D.__webglColorRenderbuffer[tt])}s.bindRenderbuffer(s.RENDERBUFFER,null),R.depthBuffer&&(D.__webglDepthRenderbuffer=s.createRenderbuffer(),ut(D.__webglDepthRenderbuffer,R,!0)),e.bindFramebuffer(s.FRAMEBUFFER,null)}}if(W){e.bindTexture(s.TEXTURE_CUBE_MAP,L.__webglTexture),mt(s.TEXTURE_CUBE_MAP,x);for(let tt=0;tt<6;tt++)if(x.mipmaps&&x.mipmaps.length>0)for(let nt=0;nt<x.mipmaps.length;nt++)Q(D.__webglFramebuffer[tt][nt],R,x,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+tt,nt);else Q(D.__webglFramebuffer[tt],R,x,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0);m(x)&&p(s.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(it){for(let tt=0,nt=K.length;tt<nt;tt++){let _t=K[tt],$=n.get(_t);e.bindTexture(s.TEXTURE_2D,$.__webglTexture),mt(s.TEXTURE_2D,_t),Q(D.__webglFramebuffer,R,_t,s.COLOR_ATTACHMENT0+tt,s.TEXTURE_2D,0),m(_t)&&p(s.TEXTURE_2D)}e.unbindTexture()}else{let tt=s.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(tt=R.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),e.bindTexture(tt,L.__webglTexture),mt(tt,x),x.mipmaps&&x.mipmaps.length>0)for(let nt=0;nt<x.mipmaps.length;nt++)Q(D.__webglFramebuffer[nt],R,x,s.COLOR_ATTACHMENT0,tt,nt);else Q(D.__webglFramebuffer,R,x,s.COLOR_ATTACHMENT0,tt,0);m(x)&&p(tt),e.unbindTexture()}R.depthBuffer&&Lt(R)}function Kt(R){let x=R.textures;for(let D=0,L=x.length;D<L;D++){let K=x[D];if(m(K)){let W=R.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:s.TEXTURE_2D,it=n.get(K).__webglTexture;e.bindTexture(W,it),p(W),e.unbindTexture()}}}let Ht=[],I=[];function ke(R){if(R.samples>0){if(Ft(R)===!1){let x=R.textures,D=R.width,L=R.height,K=s.COLOR_BUFFER_BIT,W=R.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,it=n.get(R),tt=x.length>1;if(tt)for(let nt=0;nt<x.length;nt++)e.bindFramebuffer(s.FRAMEBUFFER,it.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+nt,s.RENDERBUFFER,null),e.bindFramebuffer(s.FRAMEBUFFER,it.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+nt,s.TEXTURE_2D,null,0);e.bindFramebuffer(s.READ_FRAMEBUFFER,it.__webglMultisampledFramebuffer),e.bindFramebuffer(s.DRAW_FRAMEBUFFER,it.__webglFramebuffer);for(let nt=0;nt<x.length;nt++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(K|=s.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(K|=s.STENCIL_BUFFER_BIT)),tt){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,it.__webglColorRenderbuffer[nt]);let _t=n.get(x[nt]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,_t,0)}s.blitFramebuffer(0,0,D,L,0,0,D,L,K,s.NEAREST),c===!0&&(Ht.length=0,I.length=0,Ht.push(s.COLOR_ATTACHMENT0+nt),R.depthBuffer&&R.resolveDepthBuffer===!1&&(Ht.push(W),I.push(W),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,I)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,Ht))}if(e.bindFramebuffer(s.READ_FRAMEBUFFER,null),e.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),tt)for(let nt=0;nt<x.length;nt++){e.bindFramebuffer(s.FRAMEBUFFER,it.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+nt,s.RENDERBUFFER,it.__webglColorRenderbuffer[nt]);let _t=n.get(x[nt]).__webglTexture;e.bindFramebuffer(s.FRAMEBUFFER,it.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+nt,s.TEXTURE_2D,_t,0)}e.bindFramebuffer(s.DRAW_FRAMEBUFFER,it.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.resolveDepthBuffer===!1&&c){let x=R.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[x])}}}function Vt(R){return Math.min(i.maxSamples,R.samples)}function Ft(R){let x=n.get(R);return R.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function At(R){let x=o.render.frame;h.get(R)!==x&&(h.set(R,x),R.update())}function ie(R,x){let D=R.colorSpace,L=R.format,K=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||D!==Ee&&D!==ri&&(jt.getTransfer(D)===le?(L!==an||K!==Vn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",D)),x}function Ct(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(l.width=R.naturalWidth||R.width,l.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(l.width=R.displayWidth,l.height=R.displayHeight):(l.width=R.width,l.height=R.height),l}this.allocateTextureUnit=k,this.resetTextureUnits=w,this.setTexture2D=B,this.setTexture2DArray=Y,this.setTexture3D=H,this.setTextureCube=J,this.rebindTextures=vt,this.setupRenderTarget=Ot,this.updateRenderTargetMipmap=Kt,this.updateMultisampleRenderTarget=ke,this.setupDepthRenderbuffer=Lt,this.setupFrameBufferTexture=Q,this.useMultisampledRTT=Ft}function K_(s,t){function e(n,i=ri){let r,o=jt.getTransfer(i);if(n===Vn)return s.UNSIGNED_BYTE;if(n===dl)return s.UNSIGNED_SHORT_4_4_4_4;if(n===fl)return s.UNSIGNED_SHORT_5_5_5_1;if(n===Hu)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===Fu)return s.BYTE;if(n===Bu)return s.SHORT;if(n===sr)return s.UNSIGNED_SHORT;if(n===ul)return s.INT;if(n===Ii)return s.UNSIGNED_INT;if(n===vn)return s.FLOAT;if(n===fr)return s.HALF_FLOAT;if(n===Vu)return s.ALPHA;if(n===Gu)return s.RGB;if(n===an)return s.RGBA;if(n===Wu)return s.LUMINANCE;if(n===Xu)return s.LUMINANCE_ALPHA;if(n===fs)return s.DEPTH_COMPONENT;if(n===vs)return s.DEPTH_STENCIL;if(n===pl)return s.RED;if(n===ml)return s.RED_INTEGER;if(n===qu)return s.RG;if(n===gl)return s.RG_INTEGER;if(n===_l)return s.RGBA_INTEGER;if(n===to||n===eo||n===no||n===io)if(o===le)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===to)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===eo)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===no)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===io)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===to)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===eo)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===no)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===io)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ec||n===nc||n===ic||n===sc)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===ec)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===nc)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ic)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===sc)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===rc||n===oc||n===ac)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===rc||n===oc)return o===le?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===ac)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===cc||n===lc||n===hc||n===uc||n===dc||n===fc||n===pc||n===mc||n===gc||n===_c||n===xc||n===yc||n===vc||n===Mc)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===cc)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===lc)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===hc)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===uc)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===dc)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===fc)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===pc)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===mc)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===gc)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===_c)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===xc)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===yc)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===vc)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Mc)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===so||n===wc||n===Sc)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===so)return o===le?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===wc)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Sc)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Yu||n===bc||n===Ac||n===Tc)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===so)return r.COMPRESSED_RED_RGTC1_EXT;if(n===bc)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ac)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Tc)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===ys?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:e}}var Hc=class extends Ce{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}},St=class extends ue{constructor(){super(),this.isGroup=!0,this.type="Group"}},Z_={type:"move"},er=class{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new St,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new St,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new A,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new A),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new St,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new A,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new A),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){let e=this._hand;if(e)for(let n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let i=null,r=null,o=null,a=this._targetRay,c=this._grip,l=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(l&&t.hand){o=!0;for(let _ of t.hand.values()){let m=e.getJointPose(_,n),p=this._getHandJoint(l,_);m!==null&&(p.matrix.fromArray(m.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=m.radius),p.visible=m!==null}let h=l.joints["index-finger-tip"],u=l.joints["thumb-tip"],d=h.position.distanceTo(u.position),f=.02,g=.005;l.inputState.pinching&&d>f+g?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!l.inputState.pinching&&d<=f-g&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else c!==null&&t.gripSpace&&(r=e.getPose(t.gripSpace,n),r!==null&&(c.matrix.fromArray(r.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,r.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(r.linearVelocity)):c.hasLinearVelocity=!1,r.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(r.angularVelocity)):c.hasAngularVelocity=!1));a!==null&&(i=e.getPose(t.targetRaySpace,n),i===null&&r!==null&&(i=r),i!==null&&(a.matrix.fromArray(i.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,i.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(i.linearVelocity)):a.hasLinearVelocity=!1,i.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(i.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(Z_)))}return a!==null&&(a.visible=i!==null),c!==null&&(c.visible=r!==null),l!==null&&(l.visible=o!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){let n=new St;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}},j_=`
void main() {
...
</div>`}var qd=!1;function Kd(s){if(qd||s.querySelector("style[data-scena3d]"))return;let t=s.createElement("style");t.dataset.scena3d="1",t.textContent=Gy,s.head.appendChild(t),qd=!0}var Bv=["gotowa","minigra:start","znak:dotkniety","bohater:doszedl","latarnia:reakcja","doba:pora","swiatlo:zebrane","pauza","wznowienie","zniszczona","blad"];async function Wy(s={}){let t=typeof s.kontener=="string"?document.querySelector(s.kontener):s.kontener||document.body;if(!t)throw new Error("Scena 3D: nie znalaz\u0142em kontenera");let e=t.ownerDocument||document;Kd(e);let n=e.createElement("div");n.className="scena3d-root"+(s.panel===!1?" bez-panelu":""),n.innerHTML=Yd(s.teksty||{}),t.appendChild(n);let i=new oa(n,{zasoby:s.zasoby,spokojnyRuch:s.spokojnyRuch,klawiatura:s.klawiatura,onEvent:s.onZdarzenie}),r={element:n,on:(o,a)=>i.on(o,a),off:(o,a)=>i.off(o,a),pauza:()=>i.pauza(),wznow:()=>i.wznow(),ustawBohatera:(o,a)=>i.ustawBohatera(o,a),ustawSpokojnyRuch:o=>i.ustawSpokojnyRuch(o),ustawZasiew:o=>i.ustawZasiew(o),ustawPowrotZnaku:(o,a)=>i.ustawPowrotZnaku(o,a),pokazZnak:o=>i.pokazZnak(o),kino:(o,a)=>i.kino(o,a),kinoSkroc:()=>i.kinoSkroc(),stan:()=>i.stan(),zniszcz:()=>{i.zniszcz(),n.remove()},_app:i};try{globalThis.__SCENA=r}catch{}try{await i.gotowa}catch(o){console.error("Scena 3D: nie uda\u0142o si\u0119 wczyta\u0107 modeli",o),r.blad=String(o?.message||o)}return r}function Hv(s="ewolucja-scena-3d"){if(typeof customElements>"u"||customElements.get(s))return;class t extends HTMLElement{async connectedCallback(){if(!this._api){this.style.display=this.style.display||"block",this._api=await Wy({kontener:this,zasoby:this.getAttribute("zasoby")||void 0,panel:!this.hasAttribute("bez-panelu"),klawiatura:!this.hasAttribute("bez-klawiatury"),spokojnyRuch:this.hasAttribute("spokojny-ruch")?!0:void 0});for(let n of["pauza","wznow","ustawBohatera","ustawSpokojnyRuch","ustawZasiew","ustawPowrotZnaku","pokazZnak","stan"])this[n]=(...i)=>this._api[n](...i);this.dispatchEvent(new CustomEvent("scena3d:zamontowana",{bubbles:!0}))}}disconnectedCallback(){this._api?.zniszcz(),this._api=null}}customElements.define(s,t)}function Vv(s,t="*"){if(typeof window>"u"||window.parent===window)return()=>{};let e=s.on("*",i=>{window.parent.postMessage({scena3d:"zdarzenie",nazwa:i.nazwa,dane:i},t)}),n=i=>{let r=i.data;if(!r||r.scena3d!=="komenda"||typeof s[r.metoda]!="function")return;let o=s[r.metoda](...r.argumenty||[]);window.parent.postMessage({scena3d:"odpowiedz",metoda:r.metoda,wynik:o},t)};return addEventListener("message",n),window.parent.postMessage({scena3d:"gotowa"},t),()=>{e(),removeEventListener("message",n)}}export{Bv as ZDARZENIA,Vv as mostIframe,Wy as utworzScena3D,Hv as zarejestrujElement};
