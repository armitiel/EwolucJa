...
const LAND_CONFIG = {
  ...
  las_decyzji: {
    ...
    textColor: "#1a3d1a",
    subtitleColor: "rgba(26, 61, 26, 0.85)",
    hintColor: "rgba(26, 61, 26, 0.7)",
    hintActiveColor: "rgba(26, 61, 26, 0.9)",
  ...
  jaskinia_emocji: {
    ...
    gradient: "url(/tlo5.png) center bottom/cover no-repeat",
    particles: ["💎", "🔮", "🦋", "💧"],
    bgEmoji: "⛰️",
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        textShadow: config.textShadow || "0 3px 12px rgba(0,0,0,0.3)",
        marginBottom: "8px",
        opacity: phase === "show" ? 1 : 0,
      ...
      <div style={{
        fontSize: "18px",
        color: config.subtitleColor || "rgba(255,255,255,0.9)",
        textShadow: config.textShadow || "0 2px 8px rgba(0,0,0,0.2)",
        marginBottom: "24px",
        opacity: phase === "show" ? 1 : 0,
      ...
      <div
        style={{
          ...
          fontSize: "15px",
          fontWeight: "600",
          color: narratorDone ? (config.hintActiveColor || "rgba(255,255,255,0.85)") : (config.hintColor || "rgba(255,255,255,0.5)"),
          opacity: phase === "show" ? 1 : 0,
