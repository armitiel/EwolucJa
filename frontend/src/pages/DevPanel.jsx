    ...
    <div style={styles.wrap}>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.actionRow}>
          ...
          <button style={styles.btn} onClick={() => navigate("/world")}>/world</button>
          <button style={styles.btn} onClick={() => navigate("/map")}>/map</button>
          <button style={styles.btn} onClick={() => navigate("/backpack")}>/backpack</button>
          <button style={styles.btn} onClick={() => navigate("/profile")}>/profile</button>
          <button style={styles.btn} onClick={() => navigate("/mission")}>/mission</button>
          <button style={styles.btn} onClick={() => navigate("/reward")}>/reward</button>
